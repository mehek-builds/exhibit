...
| `audit-trimmed.json` | This run's trace audit findings (`src/observability/audit.ts`) — one hallucinated figure the code caught and discarded before it could reach the review queue |
