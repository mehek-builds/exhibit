...
| `sent-mail.json` | Every message this run actually sent: self-notices to the founder's own address (figures waiting, letter approvals requested, the first scorecard) and the one letter request sent after her `APPROVE` reply. No message was sent to anyone without her approval |
