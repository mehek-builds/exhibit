...
// Release identifier tagged onto every run and Lemma trace (PRD 6.10, 12.6): `LEMMA_RELEASE` when
...
export function currentRelease(): string {
  if (process.env.LEMMA_RELEASE) return process.env.LEMMA_RELEASE;
  try {
